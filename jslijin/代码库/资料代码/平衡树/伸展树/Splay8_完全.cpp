...
int pre[MAXN],c[MAXN][2],key[MAXN],size[MAXN];
int root,tot1;
...
void Init(){
	root = tot1 = tot2 = 0;
	c[root][0] = c[root][1] = size[root] = pre[root] = 0;
